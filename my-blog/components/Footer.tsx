...
const Footer = () => {
  ...
  return (
    <footer className="bg-accent-gray py-8">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">Modern Blog</h3>
            <p className="text-gray-600">
              A clean and modern blog with a minimalistic design focused on readability and user experience.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com/anuvednfts" target="_blank" rel="noopener noreferrer" aria-label="Twitter"
              ...
              <a href="https://instagram.com/anuved.love" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                 className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
