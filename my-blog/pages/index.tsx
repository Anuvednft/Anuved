  ...
  return (
    <Layout title="Modern Blog - Home" description="Welcome to Modern Blog, a clean and elegant blog site with minimalistic design">
      <section className="py-8 md:py-12 bg-accent-blue">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-3 md:mb-4">Modern Blog</h1>
      ...
      <section className="py-8 md:py-12">
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-center">Featured Posts</h2>
      ...
      <section className="py-8 md:py-12 bg-accent-gray">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center px-4">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Subscribe to Our Newsletter</h2>
            ...
            <form className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-3 md:px-4 py-2 rounded border border-gray-300 focus:outline-none focus:border-blue-500 text-sm md:text-base"
                required
              />
              <button
                type="submit"
